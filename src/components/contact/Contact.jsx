...
const Contact = () => {
    return (
        <section className='section' id='contact'>
            <Container>
                <div className='contact-container lg:grid lg:grid-cols-2 lg:items-stretch'>
                    <div className='mb-12 lg:mb-0 lg:flex lg:flex-col'>
                        <h2 className='h2 lg:max-w-[12ch]'>Contact me for collaboration</h2>
                        <p className='text-zinc-400 mt-3 mb-8 max-w-[50ch] lg:max-w-[30ch]'>
                            Reach out today to discuss your project needs and start collaborating on something
                            amazing!
                        </p>
                        <div className='flex gap-2 items-center '>
                            {socialLinks.map(({ href, icon }, key) => (
                                <a
                                    href={href}
                                    key={key}
                                    className='w-10 h-10 grid place-items-center ring-inset ring-2 ring-zinc-50/5 rounded-lg transition-[background-color,color] hover:bg-zinc-50 hover:text-zinc-950 active:bg-zinc-50/80'
                                    target='_blank'>
                                    {icon}
                                </a>
                            ))}
                    ...
                    <form action='https://getform.io/f/bejrokqa' method='POST' className='xl:pl-10 2xl:pl-20'>
                        ...
                        <button
                            className='btn btn-primary  bg-sky-400 border-sky-400 hover:border-sky-300 hover:bg-sky-300 active:bg-sky-500 active:border-sky-500 [&]:max-w-full w-full '
                            type='submit'>
                            Submit
                        </button>
                    </form>
